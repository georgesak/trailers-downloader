...
MAX_VIDEO_HEIGHT = 1080                  # Maximum video resolution (height)
HISTORY_FILE = 'downloaded_history.txt'  # File to store downloaded trailer history (leave blank to disable)
